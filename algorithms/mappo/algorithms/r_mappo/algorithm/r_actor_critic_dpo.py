...
class R_Actor(nn.Module):
    ...
    def get_probs(self, obs, rnn_states, masks, available_actions=None):
        ...
        action_probs_comm = self.act_ctrl.get_probs(communication_features,available_actions)
    ...
    def get_dist(self, obs, rnn_states, masks, available_actions=None):
        ...
        action_dist_comm = self.act_ctrl.get_dist(communication_features,available_actions)
        # action_probs = torch.cat((action_probs_ctrl,action_probs_comm), dim=-1)
        # dist_ret = self.act.get_dist(actor_features,available_actions)
        # print('action_probs = {}'.format(action_probs))
        # print(action_dist_comm,action_dist_ctrl)
        return action_dist_comm,action_dist_ctrl
