...
from algorithms.mappo.algorithms.bta_utils.GPT import GPTConfig, GPT, Block
from algorithms.mappo.utils.util import get_shape_from_obs_space
...
from algorithms.mappo.algorithms.bta_utils.mix import MIXBase
from algorithms.mappo.algorithms.bta_utils.rnn import RNNLayer
from algorithms.mappo.algorithms.bta_utils.distributions import DiagGaussian, FixedNormal
...
class Action_Attention(nn.Module):
    def __init__(self, args, action_space, share_obs_space, device=torch.device("cpu")):
        ...
        if action_space.__class__.__name__ == "Discrete":
            ...
            action_dim = self.continous_dim + self.discrete_dim
            # 注意
